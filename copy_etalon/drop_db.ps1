...
Param (
    [Parameter()][string]$server1c = "app01-p3  ",
    [Parameter()][string]$serverSql = "db01-p3",
    [Parameter()][string]$agentPort = "1540",
    [Parameter()][string]$infobase = "emzkoo_3_4",
    [Parameter()][string]$user = "СухотаевСВ",
    [Parameter()][string]$passw = "123",
    [Parameter()][string]$sqluser = "sa",
    [Parameter()][string]$sqlPwd = "Qwerty12345",
